...
<aside className="w-64 h-[90vh]  " aria-label="Sidebar">
   <div className="overflow-y-auto py-4 container px-3 bg-gray-100   rounded  dark:bg-gray-800 h-full">
      <ul className="space-y-5 h-full flex flex-col justify-between">
        <div>
         ...
         <li>
            <Link  href="/Store"> 
               ...
               <button className={`relative w-full  flex ${router.route=="/Store" ? "bg-green-300":"bg-transparent"} my-2 items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-green-300 dark:hover:bg-gray-700`}>
               

               <svg aria-hidden="trml-3ue" className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>

               <span className="ml-3 whitespace-nowrap">Store</span>
               <span className="absolute right-2 inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium text-gray-600 bg-green-400 rounded-full dark:bg-blue-900 dark:text-blue-200">9</span>
            </button>
         ...
         <li>
            <Link href="/Orders">
            <button className={` relative w-full flex ${router.route=="/Orders" ? "bg-green-300":"bg-transparent"}  my-2  items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-green-300 dark:hover:bg-gray-700`}>
